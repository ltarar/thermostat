...
Thermostat.prototype.usage = function() {
  if (this.temperature < this.MEDIUM_USAGE_LIMIT) return 'low-usage'
  else if (this.temperature >= this.MEDIUM_USAGE_LIMIT && this.temperature <= this.MAX_TEMP_PSM_ON) return 'medium-usage'
  return 'high-usage'
}